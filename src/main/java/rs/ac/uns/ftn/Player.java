...
import rs.ac.uns.ftn.handranking.StartingHand;
import rs.ac.uns.ftn.handranking.util.HandFactory;
...
public class Player {
    ...
    private void calculateHandStatistics(List<List<Double>> weights, int nrOpponents, boolean calculatePotential,
        ...
        List<Card> playerCards = new ArrayList<Card>(communityCards);
        playerCards.addAll(hCards);
        List<Card> enemyCards = new ArrayList<Card>(7);
        ...
        for (List<Integer> comb : combinations) {
            ...
            if(calculatePotential){
                List<Card> remainingCards = new ArrayList<Card>(uCards);
                remainingCards.remove(u1);
                remainingCards.remove(u2);
                
                List<Card> impliedPlayerCards = new ArrayList<Card>(7);
                List<Card> impliedEnemyCards = new ArrayList<Card>(7);
