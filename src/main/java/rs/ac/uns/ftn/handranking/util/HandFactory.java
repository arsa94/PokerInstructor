 ...
 */
package rs.ac.uns.ftn.handranking.util;

import rs.ac.uns.ftn.handranking.Card;
import rs.ac.uns.ftn.handranking.Hand;
import rs.ac.uns.ftn.handranking.RankableHand;
...
public class HandFactory {
    ...
    private static final HashMap<Long, Hand> EXISTING_HANDS = new HashMap<Long, Hand>();
    ...
    private static void mapHands(List<Card> allCards, int k) throws HandRankingException{
        ...
        List<Card> cardCombination = new ArrayList<Card>(k);
